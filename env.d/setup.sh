...
#################################################################################
cont_pull_url="https://yale.box.com/shared/static/x85hocw0cs4ocn5aw9gyxot2had7v7kz.sif"
SING="${SENV[sing]}"
...
[[ "${@}" =~ "all" ]] || [[ "${@}" =~ "python" ]] && \
    ...
    ./env.d/run.sh "python3.8 -m pip install --upgrade pip" && \
    ./env.d/run.sh "python3.8 -m pip install -r /project/requirements.txt"
